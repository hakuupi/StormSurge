...
ylim([min(data0)-0.1 max(data5)+0.2])
xticks(0:5:45)
xticklabels(string((160:5:205)))
xlabel("Time (3.6\times 10^3 s)")
ylabel("Storm Surge (m)")
legend("0 km","5 km","25 km","50 km","75 km","100 km","Location","northwest")
title("Storm Surge Height for Hurricane Isabel Surge Focus")
fontsize(16,"points")
